"""
Django settings for FlickList project.
...
SECRET_KEY = '1^7j55#c9fxd52--t^#4t-sx#7nl8g&ix9b9or0z8cv$p#6xiz'
...
WSGI_APPLICATION = 'FlickList.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'bhatt',      # Database password
